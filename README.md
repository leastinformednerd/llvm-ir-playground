...
[Iterator](iterator.ll) is an implementation of virtual method dispatch. I feel like it contains an extra unnecessary indirection, but I haven't looked too hard. Ironically I think writing the codegen for this section will be easier than writing it by hand was, since I'll have actual types to work with instead of opaque `ptr` types. The vtable also contains an unnecessary size field for 0 reason, I just was sure they were used in Rust and that I'd come across where they came up, and then I didn't, but didn't remove that field
